...
ATankPawn::ATankPawn()
{
	...
	TurretMesh = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("TurretMech"));
...
void ATankPawn::Tick(float DeltaTime)
{
	...
	if (TankController)
	{
		FVector MousPos = TankController->GetMousePos();
		FRotator targetRoptation = UKismetMathLibrary::FindLookAtRotation(GetActorLocation(), MousPos);
		FRotator turretRotation = TurretMesh->GetComponentRotation();
		targetRoptation.Pitch = turretRotation.Pitch;
		targetRoptation.Roll = turretRotation.Roll;
		TurretMesh->SetWorldRotation(FMath::Lerp(targetRoptation, turretRotation, TurretInterpolationKey));
